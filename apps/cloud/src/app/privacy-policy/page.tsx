...
export const metadata: Metadata = {
  title: "Polityka prywatności | Jobilot AI",
  description: "Informacja o planowanej polityce prywatności Jobilot AI.",
};
    ...
    <main className="min-h-screen bg-[#f7f7f4] px-5 py-7 text-[#20241f] sm:px-8 lg:px-12">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-12 rounded-3xl border border-[#c9d8c6] bg-[#eef4eb] p-7 shadow-sm sm:p-10">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">Polityka prywatności</h1>
          <p className="mt-5 text-sm leading-7 text-[#566054] sm:text-base">
            Wkrótce pojawi się polityka prywatności.
          </p>
        </section>
      </div>
    </main>
