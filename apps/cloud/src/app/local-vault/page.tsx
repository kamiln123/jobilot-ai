    ...
    <main className="min-h-screen bg-[#f7f7f4] px-5 py-7 text-[#20241f] sm:px-8 lg:px-12">
      <section className="mx-auto max-w-4xl">
        ...
        <section className="mt-14 rounded-2xl border border-[#c9d8c6] bg-[#eef4eb] p-7 shadow-sm sm:p-10">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-6 text-[#566054]">
          ...
          <p className="mt-3 text-xs text-[#566054]">Wersja 0.1.0 · Windows 64-bit · pobranie bez logowania</p>
        </section>

        <section className="mt-7 grid gap-5 sm:grid-cols-3">
          <article className="rounded-2xl border border-[#c9d8c6] bg-[#eef4eb] p-5">
            <h2 className="font-semibold">Offline</h2>
            <p className="mt-2 text-sm leading-6 text-[#566054]">Dane pozostają na komputerze użytkownika.</p>
          </article>
          <article className="rounded-2xl border border-[#c9d8c6] bg-[#eef4eb] p-5">
            <h2 className="font-semibold">Bez konta</h2>
            <p className="mt-2 text-sm leading-6 text-[#566054]">Brak rejestracji, synchronizacji i telemetrii.</p>
          </article>
          <article className="rounded-2xl border border-[#c9d8c6] bg-[#eef4eb] p-5">
            <h2 className="font-semibold">Oddzielna aplikacja</h2>
            <p className="mt-2 text-sm leading-6 text-[#566054]">Nie jest to przełącznik trybu Cloud Mode.</p>
          </article>
        </section>
      </section>
    </main>
