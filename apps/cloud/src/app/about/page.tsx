  ...
  return (
    <main className="min-h-screen bg-[#f7f7f4] px-5 py-7 text-[#20241f] sm:px-8 lg:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-12 rounded-3xl border border-[#e1e5dc] bg-white p-7 shadow-sm sm:p-10">
        ...
        <section className="mt-7 grid gap-7 md:grid-cols-2">
          <article className="rounded-2xl border border-[#e1e5dc] bg-white p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-[#687167]">Konto, prywatne dane użytkownika, biblioteka CV, oferty, portfolio i Application. Funkcje AI są opcjonalne i wymagają świadomej zgody.</p>
          </article>
          <article className="rounded-2xl border border-[#e1e5dc] bg-white p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-[#687167]">Oddzielna aplikacja Windows bez konta, synchronizacji, telemetrii i funkcji AI. Dane pozostają w prywatnym katalogu aplikacji na urządzeniu.</p>
        ...
        <section className="mt-7 rounded-2xl border border-[#e1e5dc] bg-white p-6 sm:p-8">
        ...
        <section className="mt-7 rounded-2xl border border-[#e1e5dc] bg-white p-6 text-sm text-[#687167] sm:p-8">
